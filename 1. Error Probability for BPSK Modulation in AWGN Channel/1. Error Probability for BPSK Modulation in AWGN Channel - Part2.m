% 1. Error Probability for BPSK Modulation in AWGN Channel - Part2
...
recx1=awgn(bpsk_symbols1,db_snr(iteration_snr));
...
title('Section 2 - BPSK in AWGN with awgn syntax');
